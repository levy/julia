...
| **The reset** | Runs the region's finalizers, checks the execution roots of every thread with the world stopped, then parks the whole page chain on the region's free list. | Constant per page. No object is touched. |
