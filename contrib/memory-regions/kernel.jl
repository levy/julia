# The minimal sequential kernel — the proven gate-as-action design from
# prototype/kernel-spike, reduced to what the latency measurement needs.
# The kernel never learns which module kinds exist.
